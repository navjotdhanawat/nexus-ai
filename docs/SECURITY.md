...
We provide security updates for the following versions of AI Playground:
...
We take security vulnerabilities seriously. If you discover a security vulnerability in AI Playground, please follow these steps:
...
Report security vulnerabilities via [GitHub Security Advisories](https://github.com/navjotdhanawat/ai-playground/security/advisories/new).
...
AI Playground includes several security measures by default:
...
When contributing to AI Playground:
...
- **Security Reports**: [GitHub Security Advisories](https://github.com/navjotdhanawat/ai-playground/security/advisories/new)
- **General Questions**: Open a [GitHub Issue](https://github.com/navjotdhanawat/ai-playground/issues)
- **Maintainer**: [Navjot Dhanawat](https://github.com/navjotdhanawat)
